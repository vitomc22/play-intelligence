...
docker exec playwright-ollama ollama pull qwen2.5-coder:1.5b
...
|--------|--------|-----------|-----------|
| **qwen2.5-coder:1.5b** | ~5GB RAM | ⭐⭐⭐⭐⭐ | ~30s/resposta |
...
| `OLLAMA_MODEL` | `qwen2.5-coder:1.5b` | Modelo Ollama a usar |
...
|---|---|---|
| `qwen2.5-coder:1.5b` | ~6 GB | **Recomendado** — especializado em código |
